typedef struct
{
   ...
   float     *fss;        /* scaling factor for point sources */
   float     *dfss;       /* uncertainty in scaling factor for point sources */
...
char      *effFile, *noiseImage, *sigmaImage, *convImage, *convNoise;
