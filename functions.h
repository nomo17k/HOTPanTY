...
void        fitKernel(stamp_struct *, float *, float *, float *, float *, double *, double *, double *, int *);
void        build_matrix0(stamp_struct *);
void        build_scprod0(stamp_struct *, float *);
double      check_stamps(stamp_struct *, int, float *, float *, float *);
void        build_matrix(stamp_struct *, int, double **);
void        build_scprod(stamp_struct *, int, float *, double *);
void        getStampSig(stamp_struct *, double *, float *, float *, double *, double *, double *);
void        getFinalStampSig(stamp_struct *, float *, float *, double *);
char        check_again(stamp_struct *, double *, float *, float *, float *, float *, double *, double *, int *);
